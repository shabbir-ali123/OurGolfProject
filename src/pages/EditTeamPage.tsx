    ...
    <div className="h-[100vh]   text-left text-lg text-white font-poppins mt-20 [background:linear-gradient(180deg,_#edfffd,_#f2fffa)]  ">
      ...
      <div className="max-w-7xl mx-auto my-4">
        <div className="flex justify-between items-center">
          ...
          <div className="mt-10">
            <button className="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" onClick={handleOpenPlayerList}>Remove Players List</button>
          </div>
        ...
        <Dialog as="div" className="relative z-10" onClose={() => setShowPlayerList(false)}>
          <Transition.Child
            as={Fragment}
            ...
            <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
              ...
              >
                <Dialog.Panel className="relative bg-white rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-lg sm:w-full sm:p-6">
                  <div>
                    <h3 className="text-lg leading-6 font-medium text-gray-900">Player List</h3>
                    <div className="mt-2">
                      <ul className="list-disc list-inside">
                        {playerList.map((player, index) => (
                          <li key={index} className="py-2">{player.name}</li>
                        ))}
                      </ul>
                    </div>
                  </div>
