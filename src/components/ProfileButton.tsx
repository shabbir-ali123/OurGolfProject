...
import Example from "./StudentCalSec";
...
export default function ProfileButton() {
  ...
  return (
    <div className=" lg:flex lg:flex-1 lg:justify-end ">
      ...
      {notification && <NotificationPop setNotification={setNotification} />}
