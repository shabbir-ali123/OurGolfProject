...
interface TeacherListProps {
  ...
  const TeacherList: React.FC<TeacherListProps> = ({ openModal }) => {
                ...
                <div className='flex justify-between items-end shadow-[0px_0px_7.47179651260376px_0px_#00000029] rounded-[30px] p-2 relative   '>
                    ...
                    <div className='mt-2 p-2 ml-3'>
                        <ul className='list-none m-0 p-0'>
                            ...
                            <FontAwesomeIcon icon={faPhoneAlt} className="w-4 h-4 rotate-90 animate__animated animate__heartBeat animate__repeat-3" />
                                <span className='ml-6 font-normal text-[9.96px] leading-3 '>
                                    85985-95415
                                </span>
                            </li>
                            <li className='flex items-center mb-2'>
                            <FontAwesomeIcon icon={faEnvelope} className="w-4 h-4 animate__animated animate__heartBeat animate__repeat-3 " />
                                <span className='ml-6 font-normal text-[9.96px] leading-3'>
