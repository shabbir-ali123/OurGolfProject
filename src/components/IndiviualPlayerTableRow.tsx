...
const IndiviualPlayerTableRow = ({item, type}: any) => {
  ...
  return (
    ...
    <div className="mt-12 flex relative items-center gap-3 box-border p-3 rounded-10xs  bg-white shadow-[0px_0px_10px_rgba(0,_0,_0,_0.25)] py-10" onClick={() => router('/user-page/'+item?.userId)}>
