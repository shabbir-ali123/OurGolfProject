...
const GigDetails: React.FC = () => {
    ...
    const timeAgo = getTimeAgo(GigDetails.createdAt, t);
        ...
        >
            <div className="flex gap-2 items-center py-4 justify-between">
                ...
                <div className="flex  gap-2">
                    ...
                    <span className="bg-green font-bold p-5 rounded text-white">¥
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
                <div className="col-span-12  ">
                    ...
                    />
                    <h2
                        dangerouslySetInnerHTML={{ __html: GigDetails?.title ?? "" }}
                    ></h2>
                    {GigDetails?.imageUrl?.map((img: string, index: number) => {
                        if (GigDetails?.imageUrl?.length === 1) {
                            return (
                                <img
                ...
                <div
                    dangerouslySetInnerHTML={{ __html: GigDetails?.description ?? "" }}
                ></div>
          ...
          <div>
            <div className="  ">
              <form method="post" className=" ">
                ...
                {GigDetails?.PostComments.map((comment: any) => {
