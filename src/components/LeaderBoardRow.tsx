...
const LeaderBoardRow: FunctionComponent<PlayerScoreProps> = ({ data }) => {
    ...
    return (
        <div className={`mt-10 rounded-md  shadow-[4px_6px_16px_#cf24eb] bg-[${rowBackgroundColor}] h-16 text-black font-poppins text-center`}>
            <div className='flex items-center h-full gap-4 px-3 leading-[18px]'>
                ...
                <div className='basis-4 flex gap-1 text-base text-seagreen-100 '>
                    <img className='' alt='' src='/img/vector.svg' />
                    <div className='leading-[20px]'>3</div>
                </div>
                <div className='basis-1/2 flex gap-2 relative'>
                    <div className='absolute top-[-10px] left-[0px] w-[161px] h-6'>
        ...
        //   </div>
        //   <div className="my-0 mx-[!important] absolute top-[5px] left-[15px] flex flex-row flex-wrap items-center justify-start gap-[53px] z-[1]">
