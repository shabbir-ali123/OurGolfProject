          ...
          <div className="grid grid-cols-9  py-8 mx-auto lg:gap-x-16 ">
            ...
            <div className="col-span-8 py-2 lg:col-span-4 md:col-span-5 md:mr-0 md:mb-3">
              ...
              <div className="relative w-full col-span-8 lg:col-span-4 md:col-span-5 md:mr-0 md:mb-2">
                ...
                <input
                  className="appearance-none block w-full bg-white text-gray-800  border-none  rounded py-4 px-4 mb-3 leading-tight focus:outline-none focus:bg-white transition duration-300 ease-in-out transform  shadow-xl"
                  id="grid-first-name"
                  name="place"
                  type="text"
