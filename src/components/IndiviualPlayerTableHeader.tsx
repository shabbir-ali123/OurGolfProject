...
const IndiviualPlayerTableHeader: FunctionComponent = () => {
    return (
        <div className='mt-9 flex items-center gap-3 box-border p-3 rounded-10xs text-white bg-lightseagreen-200 shadow-[0px_4px_10px_rgba(0,_0,_0,_0.25)]  h-20'>
            ...
            <div className='basis-1/2 min-w-[111px]'>Team Name</div>
            <div className='basis-1/3 text-center'>Total Par </div>
            <div className='basis-1/3 text-center'>Scored Par</div>
            <div className='basis-1/3 text-center'>Score</div>
        </div>
    );
};
